...
export const RDP03_INSTANCES_DATABASE_URL_MAP: Map<RDP03, string | undefined> =
  new Map([
    [RDP03.INS1, process.env.RDP02_INS1_DATABASE_URL],
    [RDP03.INS2, process.env.RDP02_INS2_DATABASE_URL],
    [RDP03.INS3, process.env.RDP02_INS3_DATABASE_URL],
    [RDP03.INS4, process.env.RDP02_INS4_DATABASE_URL],
    [RDP03.INS5, process.env.RDP02_INS5_DATABASE_URL],
